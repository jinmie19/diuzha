<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:38:"./views/home/mobile/invite/index.phtml";i:1556293574;s:67:"/www/wwwroot/diuzha.cn/public/views/home/mobile/common/footer.phtml";i:1557148301;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
            ...
            <div class="add-box">
                <div class="add-cont">
                    ...
                    <div class="clipboards" style="width:96%;display:block;margin: 0 auto;overflow: hidden;text-align: center;">
                        <a href="javascript:" id="copybtn" class="button5" onclick="copy(this)" data-copy="我玩了很多天了，每天收入不算多，四五十元，就当赚点零花钱。提现速度快，几分钟内就能到账。推荐想赚小钱的朋友进来玩玩：<?php echo $linkregis; ?>?i=<?php echo $member['uid']; ?>">复制内容</a>
                    </div>
      ...
      <li><a href="/home/account.html"><img src="/static/home/mobile/js/index/hom4<?php if(in_array($controller,array('account','charge','fans','vip','feedback','feedback','notice','help'))): ?>_on<?php endif; ?>.png"><b>我的</b></a></li>
        ...
        <script>
            window._bd_share_config = {
                common : {
                    bdText : '我玩了很多天了，每天收入不算多，四五十元，就当赚点零花钱。提现速度快，几分钟内就能到账。推荐想赚小钱的朋友进来玩玩：<?php echo $linkregis; ?>?i=<?php echo $member['uid']; ?>', 
                    bdDesc : '我玩了很多天了，每天收入不算多，四五十元，就当赚点零花钱。提现速度快，几分钟内就能到账。推荐想赚小钱的朋友进来玩玩：<?php echo $linkregis; ?>?i=<?php echo $member['uid']; ?>', 
                    bdUrl : '<?php echo $linkregis; ?>?i=<?php echo $member['uid']; ?>',   
                    bdPic : ''
                },
                share : [{
                    "bdSize" : 16
